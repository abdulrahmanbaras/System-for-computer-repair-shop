...
namespace storybored {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class servicesDataTable : global::System.Data.TypedTableBase<servicesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public servicesRow AddservicesRow(string username, int price, string month, string service, string type, int paid) {
        ...
        public partial class servicesRow : global::System.Data.DataRow {
            ...
            public string month {
                get {
                    try {
                        return ((string)(this[this.tableservices.monthColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'month\' in table \'services\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableservices.monthColumn] = value;
                }
            }
            ...
            public int paid {
                get {
                    return ((int)(this[this.tableservices.paidColumn]));
                }
                set {
                    this[this.tableservices.paidColumn] = value;
                }
            }
            ...
            public bool IsmonthNull() {
                return this.IsNull(this.tableservices.monthColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetmonthNull() {
                this[this.tableservices.monthColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace storybored.DataSet1TableAdapters {
    ...
    public partial class servicesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[services] WHERE (([Id] = @Original_Id) AND ([username] = @Original_username) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_month = 1 AND [month] IS NULL) OR ([month] = @Original_month)) AND ([service] = @Original_service) AND ([type] = @Original_type) AND ([paid] = @Original_paid))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[services] ([username], [price], [month], [service], [type], [p" +
                "aid]) VALUES (@username, @price, @month, @service, @type, @paid);\r\nSELECT Id, us" +
                "ername, price, month, service, type, paid FROM services WHERE (Id = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[services] SET [username] = @username, [price] = @price, [month] = @month, [service] = @service, [type] = @type, [paid] = @paid WHERE (([Id] = @Original_Id) AND ([username] = @Original_username) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_month = 1 AND [month] IS NULL) OR ([month] = @Original_month)) AND ([service] = @Original_service) AND ([type] = @Original_type) AND ([paid] = @Original_paid));
SELECT Id, username, price, month, service, type, paid FROM services WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::storybored.Properties.Settings.Default.myDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, price, month, service, type, paid FROM dbo.services";
        ...
        public virtual int Delete(int Original_Id, string Original_username, global::System.Nullable<int> Original_price, string Original_month, string Original_service, string Original_type, int Original_paid) {
            ...
            this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_paid));
        ...
        public virtual int Insert(string username, global::System.Nullable<int> price, string month, string service, string type, int paid) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, global::System.Nullable<int> price, string month, string service, string type, int paid, int Original_Id, string Original_username, global::System.Nullable<int> Original_price, string Original_month, string Original_service, string Original_type, int Original_paid, int Id) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
            ...
            if ((Original_service == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_service));
            }
            if ((Original_type == null)) {
                throw new global::System.ArgumentNullException("Original_type");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_paid));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, global::System.Nullable<int> price, string month, string service, string type, int paid, int Original_Id, string Original_username, global::System.Nullable<int> Original_price, string Original_month, string Original_service, string Original_type, int Original_paid) {
            return this.Update(username, price, month, service, type, paid, Original_Id, Original_username, Original_price, Original_month, Original_service, Original_type, Original_paid, Original_Id);
        }
    }
